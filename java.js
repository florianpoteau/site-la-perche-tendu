...
function getimage() {
    fetch(url + "/api/aceuils?populate=*")
        ...
        .then((result) => {
            ...
            image4Div.src = url + `${allactu.data[3].attributes.image.data[0].attributes.formats.thumbnail.url}`;

            // image 5

            image5Div.src = url + `${allactu.data[4].attributes.image.data[0].attributes.formats.thumbnail.url}`;

            // image 6

            image6Div.src = url + `${allactu.data[5].attributes.image.data[0].attributes.formats.thumbnail.url}`;

            // image7

            image7Div.src = url + `${allactu.data[6].attributes.image.data[0].attributes.formats.thumbnail.url}`;

            // image 8

            image8Div.src = url + `${allactu.data[7].attributes.image.data[0].attributes.formats.thumbnail.url}`;

            // image 9

            image9Div.src = url + `${allactu.data[8].attributes.image.data[0].attributes.formats.thumbnail.url}`;
